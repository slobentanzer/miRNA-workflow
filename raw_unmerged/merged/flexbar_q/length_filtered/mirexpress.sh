...
for read in *.fastq
  do
    ...
    if [ ! -d mirexpress/results/$dir ]; then
      ...
      ~/Programs/miRExpress/src/alignmentSIMD -r ~/Programs/miRExpress/data_v2/hsa_precursor.txt -i mirexpress/$read.stp2 -o mirexpress/results/$dir/ -u 1
